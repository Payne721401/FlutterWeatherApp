...
android {
    ...
    compileOptions {
        ...
        isCoreLibraryDesugaringEnabled = true // ADDED: Enable core library desugaring
    }
    ...
    // ADDED: Dependencies block for desugaring
    dependencies {
        coreLibraryDesugaring("com.android.tools:desugar_jdk_libs:2.1.4") // UPDATED: Use version 2.1.4
    }
}
