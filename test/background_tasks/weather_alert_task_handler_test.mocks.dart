...
// in weatherpro/test/background_tasks/weather_alert_task_handler_test.dart.
...
/// A class which mocks [AlertRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockAlertRepository extends _i1.Mock implements _i5.AlertRepository {
  MockAlertRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i6.WeatherAlert>> fetchAlerts() =>
      (super.noSuchMethod(
            Invocation.method(#fetchAlerts, []),
            returnValue: _i3.Future<List<_i6.WeatherAlert>>.value(
              <_i6.WeatherAlert>[],
            ),
          )
          as _i3.Future<List<_i6.WeatherAlert>>);
}
