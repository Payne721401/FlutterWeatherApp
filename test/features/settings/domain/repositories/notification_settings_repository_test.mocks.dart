...
// in weatherpro/test/features/settings/domain/repositories/notification_settings_repository_test.dart.
...
import 'package:weatherpro/features/settings/domain/repositories/workmanager_wrapper.dart'
    as _i4;
import 'package:workmanager/workmanager.dart' as _i5;
...
/// A class which mocks [WorkmanagerWrapper].
///
/// See the documentation for Mockito's code generation for more information.
class MockWorkmanagerWrapper extends _i1.Mock
    implements _i4.WorkmanagerWrapper {
  MockWorkmanagerWrapper() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i3.Future<void> registerOneOffTask(String? uniqueName, String? taskName) =>
      (super.noSuchMethod(
            Invocation.method(#registerOneOffTask, [uniqueName, taskName]),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
